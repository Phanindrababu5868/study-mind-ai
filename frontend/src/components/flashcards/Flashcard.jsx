  ...
  return (
    <div className="relative w-full h-72" style={{ perspective: "1000px" }}>
      ...
      >
        ...
        <div
          className="absolute inset-0 w-full h-full bg-white/80 backdrop-blur-xl border-2 border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-200/50 p-8 flex flex-col justify-between"
          style={{
        ...
        <div
          className="absolute inset-0 w-full h-full bg-linear-to-br from-emerald-500 to-teal-500 border-2 border-emerald-400/60 rounded-2xl shadow-xl shadow-emerald-500/3 p-8 flex flex-col justify-between"
          style={{
            backfaceVisibility: "hidden",
            WebkitBackfaceVisibility: "hidden",
