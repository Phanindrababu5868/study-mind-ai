    ...
    <div className="flex items-center justify-between h-full px-6">
      ...
      <div className="flex items-center gap-3 ">
        ...
        <button className="relative inline-flex items-center justify-center w-10 h-10 text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-xl transition-all duration-200 group">
          ...
          <span className="absolute top-1.5 right-1 w-2 h-2 bg-emerald-500 rounded-full ring-2 ring-white"></span>
        </button>

        {/* user Profile */}
        <div className="flex items-center gap-3 pl-3 border border-slate-200/60 ">
