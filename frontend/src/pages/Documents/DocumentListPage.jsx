      ...
      return (
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            ...
            <h3 className="text-xl font-medium text-slate-500 tracking-tight mb-2">
              No Documents Yet
            </h3>
  ...
  <div className="min-h-screen">
    ...
    <div className="relative max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-10 ">
        <div>
          <h1 className="text-xl font-medium  text-slate-900 tracking-tight mb-2">
            My Documents
          </h1>
        ...
        {documents.length>0 && (<Button onClick={()=>setIsUploadModalOpen(true)}>
    ...
    {isUploadModalOpen && <div className="fixed inset-0 z-50 flex items-center  justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
      <div className="relative w-full max-w-lg  bg-white/95 backdrop-blur-xl border border-slate-200/10 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
        {/* close Button */}
        <button
    ...
    {isDeleteModalOpen && <div className="fixed inset-0 z-50 flex items-center  justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
      <div className="relative w-full max-w-lg  bg-white/95 backdrop-blur-xl border border-slate-200/10 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
        ...
        <p className="text-sm text-slate-600 mb-6">
          Are you Sure you Want delete tHe document <span className="font-semibold text-slate-900">
            {selectedDoc?.title}? 
          </span> This action can not be undo.
        </p>
       ...
       {/* Action Buttond */}
        <div className="flex gap-3">
          ...
          onClick={()=>setIsDeleteModalOpen(false)}
          disabled={deleting}
          className="flex-1 h-11 px-4 border-2 border-slate-200 rounded-xl bg-white text-slate-700 text-sm font-semibold hover:bg-slate-50 hover:border-slate-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
          ...
          disabled={deleting}
          className="flex-1 h-11 px-4 bg-linear-to-r from-red-500 to-red-600 hover:from-red-500 hover:to-red-700 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-red-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
          >
