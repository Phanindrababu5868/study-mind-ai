    ...
    <div className="relative max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1  md:grid-cols-3 gap-6 mb-5">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="group relative bg-white/80 backdrop-blur-xl border border-slate-200/10 rounded-2xl shadow-xl shadow-slate-200/50  p-6 hover:shadow-2xl hover:shadow-slate-300/10 transition-all duration-300 hover:-translate-y-1"
          >
      ...
      <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/10 p-8">
              ...
              map((activity,index ) => (
                ...
                >
                      ...
                      <div className={`w-2 h-2 rounded-full 
                        ${activity.type ==='document'? 'bg-linear-to-r from-blue-400 to-cyan-500':'bg-linear-to-r from-emerald-400 to-teal-500'}`}/>
                          <p className='text-sm font-medium text-slate-900 truncate'>
                           {activity.type ==='document'? 'Access Document: ':'Attempted Quiz: '}
                  ...
                  <div className='text-center py-12 '>
                    <div className='inline-flex items-center justify-center w-6 h-6 rounded-2xl bg-slate-100 mb-4'>
