      ...
      <div className="relative w-full max-w-md px-6">
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-linear-to-br from-emerald-400 to-teal-500 shadow-lg shadow-emerald-500/25 mb-0">
          ...
          <div className="space-y-5">
            ...
            {error && (
              <div className="text-xs text-red-600 font-medium text-center">
                <p className="rounded-lg bg-red-50 border border-red-200 p-3">{error}</p>
              </div>
            )}
          ...
          <div className="mt-8 pt-6 border-t border-slate-200/60">
            <p className="text-center text-sm  text-slate-600">
              ...
              <Link to='/register' className="font-semibold text-emerald-500 hover:text-emerald-700 transition-colors duration-200">
                Sign up
              </Link>
            </p>
          </div>
