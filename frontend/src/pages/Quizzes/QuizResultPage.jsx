  ...
  const getScoreMessage = (score) => {
    ...
    <div className="max-w-5xl m-auto">
      ...
      <div className="mb-6">
        ...
        >
          <ArrowLeft className="w-4 h-4 group-hover:translate-x-q transition-transform duration-700" strokeWidth={2} />
          Back to Document
        </Link>
      </div>
                        ...
                        >
                          <div className="flex items-center justify-between  gap-3">
                            ...
                            <div className="flex items-center gap-2">
                              {isCorrectOption && (
                                <span className="inline-flex items-center gap-1 px-2 py-1 bg-slate-50 bg-emerald-100 border border-emerald-300 rounded-lg text-xs font-semibold text-emerald-700">
                                  <CheckCircle2 className="w-3 h-3" strokeWidth={2.5} />
                                  Correct
                                </span>
                              )}
                              {isWrongAnswer && (
                                <span className="inline-flex items-center gap-1 px-2 py-1 bg-rose-50 border border-rose-300 rounded-lg text-xs font-semibold text-rose-700">
      ...
      <div className="mt-8 flex justify-center">
        <Link to={`/documents/${quiz.document._id}`}>
          <button className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600  hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-300 shadow-lg shadow-emerald-500/25 hover:shadow-xl  overflow-hidden">
